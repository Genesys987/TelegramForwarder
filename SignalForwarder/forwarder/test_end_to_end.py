...
Stop loss at 88600.00"""
    ...
    def test_multiple_signal_formats(self):
        ...
        test_signals = [
            ...
            ("BUY BTCUSD\nENTRY 89300.00\nTake profit 1 at 89500.00\nTake profit 2 at 89800.00\nTake profit 3 at 90300.00\nStop loss at 88600.00", "BTCUSD", "BUY"),
            
            # Signal 2: GOLD FROM range format  
            ("GOLD BUY FROM 3362/3360\n\nTP 3364\nTP 3366\nTP 3368\nTP 3370\nTP 3372\nSL 3350\n\nUSE RISK MANAGEMENT", "XAUUSD", "BUY"),
            
            # Signal 3: Emoji alert format
            ("SIGNAL ALERT\n\nSELL XAUUSD 3290.5\n\n🤑TP1: 3289.0\n🤑TP2: 3287.5\n🤑TP3: 3281.4\n🔴SL: 3298.8 (830 pips)", "XAUUSD", "SELL"),
            
            # Signal 4: Colon format
            ("EURUSD BUY\n\nENTRY 1.1435\n\nTP: 1.1455\nTP: 1.1485\nTP: 1.1535\nSL: 1.1345", "EURUSD", "BUY"),
        ...
        for i, (signal_text, expected_symbol, expected_type) in enumerate(test_signals, 1):
